    ...
    <>
      <section className="my-hobbies lg:p-20 min-[350px]:p-2 min-[350px]:mt-10">
        ...
        <div className="flex items-center justify-around hobbies flex-wrap">
          <div data-aos="fade-up"  data-aos-offset="420" className="flex m-5 p-3 hobby justify-center items-center text-4xl w-64 min-[350px]:text-sm min-[350px]:m-1 md:m-3">
