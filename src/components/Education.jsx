    ...
    <>
      <section className="my-education pl-20 pr-20 pb-20 max-[499px]:pl-2 max-[499px]:pr-2 max-[499px]:flex-col">
        ...
        <div className="flex items-center justify-between text-center max-[499px]:flex-col max-[899px]:flex-col">
          <div className="text-4xl w-[540px] p-5 education max-[499px]:text-sm max-[499px]:mb-5 max-[499px]:w-80 max-[899px]:mb-10 max-[899px]:w-[640px]">
          ...
          <div className="text-4xl w-[540px] p-5 education max-[499px]:text-sm max-[499px]:w-80 max-[899px]:w-[640px]">
